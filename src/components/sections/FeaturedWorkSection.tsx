  ...
  return (
    <section className="border-t border-line pt-24">
      <div className="text-center mb-16 px-4">
        <Reveal>
          <h3 className="text-xs font-medium uppercase tracking-widest mb-6 text-muted">See Our Work</h3>
        </Reveal>
        <Reveal delay={0.08}>
      ...
      <div className="px-4 sm:px-6 mb-12">
        <motion.div
          ref={stripRef}
          className="w-full aspect-[16/9] sm:aspect-[21/9] relative overflow-hidden bg-spot cursor-pointer group"
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <h1 className="text-[15vw] sm:text-[12vw] font-black italic text-on-footer leading-none text-center transform -rotate-3 drop-shadow-lg">
              DIKARA
              <br />
              STUDIO
            </h1>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 border-t border-line text-sm">
        <Reveal className="p-6 flex flex-col gap-2 border-r border-b sm:border-b-0 border-line">
          <span className="text-muted-2 uppercase tracking-widest text-[10px] font-medium">Client</span>
          <span className="font-medium">Emporio Armani</span>
        </Reveal>
        <Reveal className="p-6 flex flex-col gap-2 border-b sm:border-b-0 sm:border-r border-line" delay={0.04}>
          <span className="text-muted-2 uppercase tracking-widest text-[10px] font-medium">Date</span>
        ...
        <Reveal className="p-6 flex flex-col gap-2 col-span-2 sm:col-span-1" delay={0.08}>
          <span className="text-muted-2 uppercase tracking-widest text-[10px] font-medium">Photographer</span>
